    ...
    <section id="services" className="bg-white py-24 px-4 border-t border-slate-50">
      <div className="container mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="inline-block bg-[#EBE9F9] text-[#35268F] font-bold uppercase tracking-[0.12em] text-[13px] px-4 py-1.5 rounded-full mb-4">What We Do</span>
          <h2 className="text-[32px] md:text-[36px] font-extrabold text-[#1A1040] leading-[1.2] mb-4">Cybersecurity and IT Audit<br />Services We Offer</h2>
          <p className="text-[#60697b] text-[16px] md:text-[18px] leading-relaxed">From checking for vulnerabilities to building full governance frameworks, we cover every layer of IT security and assurance.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-[21px] font-bold text-[#1A1040] mb-3 group-hover:text-[#35268F] transition-colors">{service.title}</h3>
              <p className="text-[#60697b] mb-6 text-[15px] md:text-[16px] leading-[1.65] flex-grow">{service.description}</p>
          ...
          <div className="bg-aaa-primary text-white p-10 rounded-3xl shadow-2xl flex flex-col justify-center relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold mb-4 tracking-tight">Not sure where to start?</h3>
