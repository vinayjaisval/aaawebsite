          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <nav className="flex items-center gap-2 mb-8 text-[10px] sm:text-[11px] font-bold uppercase tracking-widest text-white/40 overflow-x-auto no-scrollbar whitespace-nowrap">
                ...
                <ChevronRight className="w-3 h-3 text-white/20 shrink-0" />
                <span className="text-aaa-primary uppercase tracking-widest font-black shrink-0">IT Security Audit</span>
              </nav>
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="w-full lg:w-7/12">
                ...
                <div className="text-slate-600 sm:text-[17px] leading-relaxed mb-12">
                  <div className="space-y-6 mb-12">
                    <p className="font-medium text-slate-800 mb-8 sm:mb-10 text-sm sm:text-base border-l-4 border-aaa-primary/10 pl-4 sm:pl-6 py-2 bg-slate-50/30 rounded-r-xl italic shadow-sm leading-relaxed">
                  ...
                  <div className="bg-slate-900 p-6 sm:p-10 rounded-3xl mb-12 sm:mb-16 text-white relative overflow-hidden group">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-aaa-primary/10 blur-3xl opacity-50" />
                    <h4 className="text-aaa-primary font-black mb-4 flex items-center gap-2 uppercase tracking-widest text-[10px] sm:text-[11px]">
                  ...
                  <div className="space-y-8 sm:space-y-12">
                    <div className="flex items-center gap-6">
                      <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.4em] whitespace-nowrap italic">Audit Portfolio</h3>
                      <div className="h-px w-full bg-slate-100" />
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      {auditTypes.map((type, i) => (
                        <div key={i} className="flex items-center gap-4 p-4 sm:p-5 bg-white border border-slate-100 rounded-2xl hover:bg-[#0f172a] hover:text-white transition-all duration-300 group cursor-default shadow-sm italic">
