            ...
            <div className="flex flex-col lg:flex-row gap-16 items-start">
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="w-full lg:w-7/12">
                <div className="space-y-4 mb-12">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight leading-tight uppercase italic underline decoration-aaa-primary/5 decoration-8 underline-offset-4">
                ...
                <div className="text-slate-600 text-[17px] leading-relaxed mb-12">
                  ...
                  <div className="bg-slate-900 p-8 rounded-3xl mb-16 text-white relative overflow-hidden group">
                    ...
                    <div className="flex justify-center p-6 bg-white/5 rounded-2xl border border-white/5 group-hover:bg-white/10 transition-all">
